...
#SBATCH --output=/home/sukrit.koirala/ondemand/upload_me/RegionTokenizer/scripts/RL/logs/mvp4c0_audit-%j.out
#SBATCH --error=/home/sukrit.koirala/ondemand/upload_me/RegionTokenizer/scripts/RL/logs/mvp4c0_audit-%j.err
...
OUTPUT=$RL_BASE/outputs_mvp4c0_delayed_credit_audit_fast

mkdir -p $RL_BASE/logs
mkdir -p $OUTPUT

# ── Run ───────────────────────────────────────────────────────────────────────
python $RL_BASE/src/run_mvp4c0_delayed_credit_audit.py \
  --source         $SOURCE           \
